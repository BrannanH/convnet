...
public interface Layer {
     ...
     * @return
     */
    ForwardOutputTuple forward(MDA operand, Feature feature);
     ...
     * @return
     */
    MDA forwardNoTrain(MDA operand, Feature feature);
     ...
     * @return
     */
    List<Integer> outputDimensions(List<Integer> inputDimensions, Feature feature);
}
