...
public class DimensionVerificationService {
     ...
     * @return
     */
    public void verify(List<Integer> inputDimensions, List<Integer> poolSizes) {
     ...
     * @return
     */
    public boolean verifyDerivativeMap(Map<List<Integer>, Map<List<Integer>, Double>> testMap) {
