...
abstract class OperationService {
    ...
    public MDA operate(MDA operand1, MDA operand2) {
        if (operand1.getDimensions().size() != operand2.getDimensions().size()) {
            throw new IllegalArgumentException(
                    "Dimensional Mis-match between summed arrays, they have different lengths");
        }
     ...
     * calculated using the same location from the two operand MDAs.
     * 
     * @param result
     * @param operand1
     * @param operand2
    ...
    /**
     * This abstract method allows for numerous implementations of element wise
     * operation.
     * 
     * @param operand1
     * @param operand2
    ...
    /**
     * This abstract method allows for numerous implementations of the constant
     * operation.
     * 
     * @param operand1
     * @param operand2
