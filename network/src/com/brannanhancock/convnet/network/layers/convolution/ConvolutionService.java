...
class ConvolutionService {
    ...
    public boolean verifyOperandSatisfiesInputDimensions(int[] actualInputDimensions, int[] declaredInputDimensions) {
        return HelperLibrary.isArrayEquality(actualInputDimensions, declaredInputDimensions);
    }
